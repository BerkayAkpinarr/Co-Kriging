...
class CMIP6Extraction(object):
    def __init__(self):
        self.input = r"/home/baris/Desktop/new/data/cmip6/models/pr_day_ACCESS-CM2_historical_r1i1p1f1_gn_1995_2004"
    ...
    def find_cmip6_netcdf(self):
        for cmip6 in pathlib.Path(self.input).glob('**/*2025*.nc'):
    ...
    def extract_cmip6(self, cmip6_nc_path, cmip6_shp_path):
        ...
        for i in range(len(shp_df)):
            ...
            values = dataset.pr.to_numpy()*86400
        ...
        self.results_database.to_csv(os.path.join(self.output, cmip6_name+'_cmip6_future.csv'),index=False)
